...
import { z } from 'zod';
import { Eye, EyeOff, Shield, TrendingUp, Mail, Lock, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen relative overflow-hidden bg-[#070a13] flex items-center justify-center p-4">
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <div className="text-center animate-fadeIn">
          ...
          <p className="text-slate-400 mt-2 font-medium">Sign in to detect financial irregularities</p>
        </div>
        ...
        <Interactive3DTiltCard className="w-full">
          <div className="backdrop-blur-xl bg-slate-900/60 border border-slate-800/60 shadow-[0_25px_60px_rgba(0,0,0,0.65)] rounded-2xl p-8 relative">
            ...
            <div className="space-y-6">
              ...
              {/* Error Display */}
              {error && (
                <div className="bg-red-500/10 border border-red-500/20 rounded-xl p-4 flex items-start space-x-3 animate-fadeIn">
                  <AlertCircle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                  <div>
                    <h3 className="text-sm font-semibold text-red-300">Authentication Error</h3>
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase tracking-wider">
                  <span className="px-3 bg-[#111726] text-slate-400 font-semibold rounded">Or continue with email</span>
                </div>
              </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <input
                      ...
                      name="remember-me"
                      type="checkbox"
                      className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-slate-800 bg-slate-950 rounded cursor-pointer"
                    />
                    <label htmlFor="remember-me" className="ml-2 block text-xs text-slate-400 font-semibold cursor-pointer">
                      Remember me
                    </label>
                  </div>
