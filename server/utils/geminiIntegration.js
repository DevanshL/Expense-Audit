...
- Chi-Square statistic: ${(analysisData.chiSquare ?? 0).toFixed(2)}
...
RISK ASSESSMENT:
[Explain the MAD score of ${analysisData.mad.toFixed(4)} and Chi-Square of ${(analysisData.chiSquare ?? 0).toFixed(2)} in business terms, and what the ${analysisData.riskLevel} risk level means for the organization]
